...
/**
 * Deze activiteit vraagt de gebruiker met welke vrienden hij momenteel is. De
 * vrienden waaruit hij keuze heeft, zijn zijn contactpersonen in de gsm.
 * 
 * @author Stijn
 * 
 */
public class FriendsActivity extends Activity {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		ContactsArrayAdapter adapter = new ContactsArrayAdapter(
				getApplicationContext(), R.layout.contacts_view_row,
				contactList);

		initContacsListView(adapter);
		initOKButton();

		nbOfFriendsSelected = (TextView) this
				.findViewById(R.id.contacts_list_friends_selected);
	}

	/**
	 * Deze methode verwijdert de meegegeven favorieten uit de meegegeven
	 * contacten.
	 * 
	 * @param contactList
	 ...
	 */
	private List<Contact> deleteFavoritesOutContacts(List<Contact> contactList,
			Contact[] favorites) {
	...
	private void initOKButton() {
		Button button = (Button) this
				.findViewById(R.id.contacts_list_button_ok);
	...
	private Contact[] initFavorites() {
		ImageView firstFav = (ImageView) this
				.findViewById(R.id.contacts_view_first_contact);
		ImageView secondFav = (ImageView) this
				.findViewById(R.id.contacts_view_second_contact);
		ImageView thirdFav = (ImageView) this
				.findViewById(R.id.contacts_view_third_contact);
	 ...
	 * 
	 * @return Een lijst met daarin alle contactpersonen uit de gsm van de
	 *         gebruker. Enkel contacten met een telefoonnummer worden hierin
	 *         opgenomen.
	 */
	...
	/**
	 * Methode die aangeeft wat er moet gebeuren wanneer er op een contactview
	 * wordt geklikt.
	 * 
	 * @param v
	...
	private void setNbOfFriendsSelected() {
		...
		if (size == 1) {
			nbOfFriendsSelected.setText(selectedContacts.size()
					+ " friend selected");
		} else {
			nbOfFriendsSelected.setText(selectedContacts.size()
					+ " friends selected");
			...
			public void onClick(View v) {
				...
				for (int i = 0; i < selectedContacts.size(); i++) {
					...
					selectedContactsNames
							.add(selectedContacts.get(i).getName());
				}
